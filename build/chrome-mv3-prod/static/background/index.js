var e,t;"function"==typeof(e=globalThis.define)&&(t=e,e=null),function(t,a,i,n,r){var l="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},s="function"==typeof l[n]&&l[n],o=s.cache||{},u="undefined"!=typeof module&&"function"==typeof module.require&&module.require.bind(module);function c(e,a){if(!o[e]){if(!t[e]){var i="function"==typeof l[n]&&l[n];if(!a&&i)return i(e,!0);if(s)return s(e,!0);if(u&&"string"==typeof e)return u(e);var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}d.resolve=function(a){var i=t[e][1][a];return null!=i?i:a},d.cache={};var m=o[e]=new c.Module(e);t[e][0].call(m.exports,d,m,m.exports,this)}return o[e].exports;function d(e){var t=d.resolve(e);return!1===t?{}:c(t)}}c.isParcelRequire=!0,c.Module=function(e){this.id=e,this.bundle=c,this.exports={}},c.modules=t,c.cache=o,c.parent=s,c.register=function(e,a){t[e]=[function(e,t){t.exports=a},{}]},Object.defineProperty(c,"root",{get:function(){return l[n]}}),l[n]=c;for(var m=0;m<a.length;m++)c(a[m]);if(i){var d=c(i);"object"==typeof exports&&"undefined"!=typeof module?module.exports=d:"function"==typeof e&&e.amd?e(function(){return d}):r&&(this[r]=d)}}({kgW6q:[function(e,t,a){e("../../../src/background")},{"../../../src/background":"fx8Od"}],fx8Od:[function(e,t,a){var i=e("@parcel/transformer-js/src/esmodule-helpers.js");i.defineInteropFlag(a),i.export(a,"fetchStats",()=>L),i.export(a,"executeSearch",()=>C),i.export(a,"fetchItems",()=>k);var n=e("~types");let r=null,l=null,s=null,o=new Map;async function u(){if(!s){try{let e=await S("affixFingerprints");if(e.affixFingerprints?.version===2&&e.affixFingerprints?.data){let t=e.affixFingerprints.data;for(let[e,a]of Object.entries(t))o.set(e,new Set(a));s={},console.log(`[PoE2] Affix fingerprints restored from cache: ${o.size} categories`);return}}catch(e){}try{let e=chrome.runtime.getURL("poe2-base-affixes.json"),t=await fetch(e);if(!t.ok)throw Error(`Affix DB load failed: ${t.status}`);for(let e of(s=await t.json()).categories){if(!e.affixes&&!e.base_items)continue;let t=new Set,a=e=>{if(!e)return;let a=e.replace(/^\d+\s+/,"").replace(/\s+[A-Z][a-zA-Z,]*\s+\d+\s*$/g,"").replace(/\s+[a-z]+\s*$/g,"").trim();if(!a)return;let i=a.replace(/\([\d.\u2014]+\)/g,"#").replace(/[\d.]+/g,"#").replace(/[+\-%]/g,"").replace(/\s+/g," ").trim().toLowerCase();i.length>3&&i.split(" ").length>=3&&t.add(i)};for(let t of e.affixes||[])a(t.details||t.stat_text||"");for(let t of e.base_items||[])for(let e of t.implicits||[])a(e);o.set(e.slug,t)}for(let[e,t]of Object.entries(p)){let a=new Set;for(let e of t){let t=o.get(e);if(t)for(let e of t)a.add(e)}o.set(e,a),console.log(`[PoE2] Merged ${e}: ${a.size} fingerprints from ${t.length} subcategories`)}console.log(`[PoE2] Affix DB loaded: ${s.categories.length} categories`),m();let a={};for(let[e,t]of o)a[e]=[...t];T({affixFingerprints:{version:2,data:a}}).catch(()=>{})}catch(e){console.warn("[PoE2] Affix DB not available:",e)}}}let c=null;function m(){if(s){for(let e of(c=new Map,s.categories))for(let t of e.affixes||[]){let e=t.details;if(!e)continue;let a=e.match(/^(\d+)\s+/);if(!a)continue;let i=parseInt(a[1],10),n=e.replace(/^\d+\s+/,"").replace(/\s+[A-Z][a-zA-Z,]*\s+\d+\s*$/g,"").replace(/\s+[a-z]+\s*$/g,"").trim();if(!n)continue;let r=n.replace(/\([\d.\u2014]+\)/g,"#").replace(/[\d.]+/g,"#").replace(/[+\-%]/g,"").replace(/\s+/g," ").trim().toLowerCase();if(!r||r.split(" ").length<2)continue;let l=c.get(r)||[];l.some(e=>e.level===i)||l.push({level:i,detail:n}),c.set(r,l)}for(let e of c.values())e.sort((e,t)=>t.level-e.level);console.log(`[PoE2] Mod tier lookup built: ${c.size} unique mod patterns`)}}let d={Ring:"Rings",Amulet:"Amulets",Belt:"Belts",Boots:"Boots",Gloves:"Gloves",Helmet:"Helmets","Body Armour":"Body Armours",Focus:"Foci",Quiver:"Quivers",Bow:"Bows",Crossbow:"Crossbows",Claw:"Claws",Dagger:"Daggers","One Handed Sword":"One_Hand_Swords","One Handed Axe":"One_Hand_Axes","One Handed Mace":"One_Hand_Maces","Two Handed Sword":"Two_Hand_Swords","Two Handed Axe":"Two_Hand_Axes","Two Handed Mace":"Two_Hand_Maces",Spear:"Spears",Flail:"Flails",Quarterstaff:"Quarterstaves",Wand:"Wands",Sceptre:"Sceptres",Staff:"Staves"},p={Boots:["Boots_str","Boots_dex","Boots_int","Boots_str_dex","Boots_str_int","Boots_dex_int"],Gloves:["Gloves_str","Gloves_dex","Gloves_int","Gloves_str_dex","Gloves_str_int","Gloves_dex_int"],Helmets:["Helmets_str","Helmets_dex","Helmets_int","Helmets_str_dex","Helmets_str_int","Helmets_dex_int"],"Body Armours":["Body_Armours_str","Body_Armours_dex","Body_Armours_int","Body_Armours_str_dex","Body_Armours_str_int","Body_Armours_dex_int"]};function f(e){return e.replace(/^\d+\s+/,"").replace(/\s+[A-Z][a-zA-Z,]*\s+\d+\s*$/g,"").replace(/\s+[a-z]+\s*$/g,"").trim().replace(/\([\d.\u2014]+\)/g,"#").replace(/[\d.]+/g,"#").replace(/[+\-%]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function g(e){let t=e.match(/\(([\d.]+)\u2014([\d.]+)\)/g);if(!t||0===t.length)return null;let a=e=>{let t=e.match(/\(([\d.]+)\u2014([\d.]+)\)/);return t?{min:parseFloat(t[1]),max:parseFloat(t[2])}:null};if(1===t.length){let e=a(t[0]);return e?(e.min+e.max)/2:null}let i=a(t[0]),n=a(t[t.length-1]);return i&&n?(i.min+n.min)/2:null}async function h(){if(r)return r;try{let e=await S("enZhDict");if(e.enZhDict&&Object.keys(e.enZhDict).length>0)return r=e.enZhDict,e.dictIndex&&Array.isArray(e.dictIndex)?(l=new Map(e.dictIndex),console.log(`[PoE2] Dict index restored from cache: ${l.size} entries`)):y(),console.log(`[PoE2] Dictionary loaded from cache: ${Object.keys(r).length} entries`),r}catch(e){}try{let e=chrome.runtime.getURL("poe2_en_zh.json"),t=await fetch(e);if(!t.ok)throw Error(`Dict load failed: ${t.status}`);return r=await t.json(),y(),console.log(`[PoE2] Dictionary loaded: ${Object.keys(r).length} entries`),T({enZhDict:r,dictIndex:l?[...l.entries()]:[]}).catch(()=>{}),r}catch(e){return console.warn("[PoE2] Dictionary not available, translations disabled:",e),r={},{}}}function y(){if(!r){l=null;return}for(let[e,t]of(l=new Map,Object.entries(r)))l.set(x(e),t)}function x(e){return e.replace(/[+\-]?\d+(?:\.\d+)?/g,"#").replace(/^[+\-]\s*/,"").replace(/\s+/g," ").trim().toLowerCase()}function w(e){if(!r||0===Object.keys(r).length)return null;let t=e.match(/[+\-]?\d+(?:\.\d+)?/g)||[],a=x(e);if(!a)return null;if(l){let e=l.get(a);if(e)return function(e,t){if(!t.length)return e;let a=0;return e.replace(/#/g,()=>{let e=t[a];return a=(a+1)%t.length,e||"#"})}(e,t)}return null}async function E(){return new Promise(e=>{chrome.storage.local.get("settings",t=>{if(chrome.runtime.lastError){console.warn("[PoE2] getSettings error:",chrome.runtime.lastError),e({...n.DEFAULT_SETTINGS});return}chrome.storage.local.get(null,e=>{console.log("[PoE2] getSettings: result_keys=",Object.keys(t||{}),"all_keys=",Object.keys(e||{}))}),e(t?.settings||n.DEFAULT_SETTINGS)})})}async function v(e){return new Promise((t,a)=>{console.log("[PoE2] saveSettings: saving key_len="+(e?.aiProvider?.apiKey?.length||0)),chrome.storage.local.set({settings:e},()=>{chrome.runtime.lastError?(console.error("[PoE2] saveSettings error:",chrome.runtime.lastError),a(Error("\u4fdd\u5b58\u5931\u8d25: "+chrome.runtime.lastError.message))):(console.log("[PoE2] saveSettings: set callback OK"),t())})})}function S(e){return new Promise(t=>{chrome.storage.local.get(e,e=>{chrome.runtime.lastError?(console.warn("[PoE2] storageGet error:",chrome.runtime.lastError),t({})):t(e||{})})})}function T(e){return new Promise(t=>{chrome.storage.local.set(e,()=>{chrome.runtime.lastError&&console.warn("[PoE2] storageSet error:",chrome.runtime.lastError),t()})})}let _=`## Reference: Common Stat Descriptions (exact English \u2192 Chinese)
...
`,A="https://www.pathofexile.com/api/trade2",b=null,q=0;async function L(){if(b&&Date.now()-q<36e5)return b;try{let e=await S("statsCache");if(e.statsCache?.entries&&e.statsCache?.timestamp&&Date.now()-e.statsCache.timestamp<36e5){let t=e.statsCache.entries,a=Array.isArray(t)&&t.length>100&&t.every(e=>"string"==typeof e.id&&e.id.length>3);if(a)return b=t,q=e.statsCache.timestamp,b;console.warn("[PoE2] Stats cache corrupted, clearing and re-fetching"),T({statsCache:null}).catch(()=>{})}}catch(e){}let e=await fetch(`${A}/data/stats`);if(!e.ok)throw Error(`Stats API returned ${e.status}`);let t=await e.json(),a=[];for(let e of t.result||[])for(let t of e.entries||[])a.push({id:t.id,text:t.text,type:t.type,option:t.option});return b=a,T({statsCache:{entries:a,timestamp:q=Date.now()}}).catch(()=>{}),a}async function C(e,t){let a=await fetch(`${A}/search/${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!a.ok){let e;let t=await a.text();try{let i=JSON.parse(t),n=i.error||"";e=n.includes("Invalid query")?"\u67e5\u8be2\u65e0\u6548 \u2014 \u53ef\u80fd\u662f\u7f13\u5b58\u6570\u636e\u635f\u574f\u3002\u8bf7\u5c1d\u8bd5\uff1a\u6269\u5c55\u7ba1\u7406 \u2192 \u6e05\u9664\u5b58\u50a8 \u2192 \u91cd\u65b0\u52a0\u8f7d\u9875\u9762\u3002":n.includes("too complex")||n.includes("reduce")?"\u67e5\u8be2\u592a\u590d\u6742\uff0c\u5339\u914d\u7ed3\u679c\u592a\u591a\u3002\u8bf7\u52a0\u4e0a\u66f4\u591a\u9650\u5236\u6761\u4ef6\uff08\u6bd4\u5982\u4ef7\u683c\u8303\u56f4\u3001\u5177\u4f53\u7684\u88c5\u5907\u7c7b\u578b\uff09\u6765\u7f29\u5c0f\u7ed3\u679c\u3002":`API \u9519\u8bef (${a.status}): ${n}`}catch{e=`\u641c\u7d22\u5931\u8d25 (${a.status})\uff0c\u8bf7\u91cd\u8bd5\u6216\u5237\u65b0\u9875\u9762\u3002`}throw Error(e)}return a.json()}async function k(e,t){let a=await fetch(`${A}/fetch/${e.join(",")}?query=${t}`);if(!a.ok){let e=await a.text();throw Error(`Fetch API returned ${a.status}: ${e.slice(0,200)}`)}return a.json()}let O=`You are a Path of Exile 2 trade search parser. Convert the user's Chinese natural language search into a JSON search intent.
...
${_}`;function R(e,t){let a=e.toLowerCase().replace(/[#+\-%]/g,"").replace(/\s+/g," ").trim(),i=null,n=0,r=e.toLowerCase(),l=/gain|extra|\u989d\u5916/.test(r),s=/add|\u9644\u52a0/.test(r);for(let e of t){let t=(e.text||"").toLowerCase().replace(/[#+\-%]/g,"").replace(/\s+/g," ").trim();if(t===a&&!String(e.id).startsWith("pseudo."))return e;if(!String(e.id).startsWith("pseudo.")&&(t.includes(a)||a.includes(t))){let r=Math.min(t.length,a.length)/Math.max(t.length,a.length),o=(e.text||"").toLowerCase(),u=/^adds\b/.test(o),c=/^gain\b.*\bextra\b/.test(o);l&&u&&!c&&(r*=.1),s&&!l&&c&&(r*=.1),r>n&&(n=r,i=e)}}if(!i)for(let e of t){let t=(e.text||"").toLowerCase().replace(/[#+\-%]/g,"").replace(/\s+/g," ").trim();if(t===a)return e}if(!i){let e=a.split(/\s+/).filter(e=>e.length>2);for(let a of t){let t=(a.text||"").toLowerCase(),r=e.filter(e=>t.includes(e)).length,o=r/e.length,u=(a.text||"").toLowerCase(),c=/^adds\b/.test(u),m=/^gain\b.*\bextra\b/.test(u);l&&c&&!m&&(o*=.1),s&&!l&&m&&(o*=.1),o>.5&&o>n&&(n=o,i=a)}}return i}async function D(e,t){if(!t.apiKey||t.apiKey.length<3)throw Error("API Key \u672a\u8bbe\u7f6e\u6216\u592a\u77ed \u2014 \u8bf7\u5728 \u2699\ufe0f \u8bbe\u7f6e\u4e2d\u586b\u5199");if(!t.apiUrl)throw Error("API URL \u672a\u8bbe\u7f6e \u2014 \u8bf7\u5728 \u2699\ufe0f \u8bbe\u7f6e\u4e2d\u586b\u5199");let a=await fetch(t.apiUrl,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify({model:t.model,messages:[{role:"system",content:O},{role:"user",content:e}],temperature:.1,max_tokens:2e3})});if(!a.ok){let e=await a.text(),t=e.slice(0,200);throw console.error("[PoE2] AI API error:",a.status,t),Error(`AI API \u8fd4\u56de ${a.status}: ${t}`)}let i=await a.json();return i.choices?.[0]?.message?.content||""}let $=new Map,P={"to maximum Life":"\u6700\u5927\u751f\u547d","to maximum Mana":"\u6700\u5927\u9b54\u529b","to maximum Energy Shield":"\u6700\u5927\u80fd\u91cf\u62a4\u76fe","to Strength":"\u529b\u91cf","to Dexterity":"\u654f\u6377","to Intelligence":"\u667a\u6167","to all Attributes":"\u5168\u5c5e\u6027","to Fire Resistance":"\u706b\u7130\u6297\u6027","to Cold Resistance":"\u51b0\u51b7\u6297\u6027","to Lightning Resistance":"\u95ea\u7535\u6297\u6027","to Chaos Resistance":"\u6df7\u6c8c\u6297\u6027","to all Elemental Resistances":"\u5168\u5143\u7d20\u6297\u6027","increased Rarity of Items found":"\u7269\u54c1\u7a00\u6709\u5ea6\u63d0\u9ad8","increased Movement Speed":"\u79fb\u52a8\u901f\u5ea6\u63d0\u9ad8","increased Attack Speed":"\u653b\u51fb\u901f\u5ea6\u63d0\u9ad8","increased Cast Speed":"\u65bd\u6cd5\u901f\u5ea6\u63d0\u9ad8","to Spirit":"\u7cbe\u9b42","physical damage":"\u7269\u7406\u4f24\u5bb3","fire damage":"\u706b\u7130\u4f24\u5bb3","cold damage":"\u51b0\u51b7\u4f24\u5bb3","lightning damage":"\u95ea\u7535\u4f24\u5bb3","chaos damage":"\u6df7\u6c8c\u4f24\u5bb3",adds:"\u9644\u52a0",increased:"\u63d0\u9ad8",reduced:"\u964d\u4f4e",more:"\u66f4\u591a",less:"\u66f4\u5c11",gain:"\u7372\u5f97",extra:"\u984d\u5916","gain as extra":"\u7372\u5f97\u984d\u5916","Critical Strike Chance":"\u66b4\u51fb\u7387","Critical Hit Chance":"\u66b4\u51fb\u7387","Critical Damage Bonus":"\u66b4\u51fb\u4f24\u5bb3\u52a0\u6210","attack damage":"\u653b\u51fb\u4f24\u5bb3","spell damage":"\u6cd5\u672f\u4f24\u5bb3","elemental damage":"\u5143\u7d20\u4f24\u5bb3","minion damage":"\u53ec\u5524\u7269\u4f24\u5bb3",Armour:"\u62a4\u7532",Evasion:"\u95ea\u907f","Energy Shield":"\u80fd\u91cf\u62a4\u76fe","Life Regeneration":"\u751f\u547d\u56de\u590d","Mana Regeneration":"\u9b54\u529b\u56de\u590d","Life Recovery":"\u751f\u547d\u6062\u590d","stun recovery":"\u6655\u7729\u56de\u590d","Block chance":"\u683c\u6321\u7387","Spell Suppression":"\u6cd5\u672f\u538b\u5236","chance to Suppress Spell Damage":"\u6cd5\u672f\u538b\u5236\u7387"};async function I(e){switch(e.type){case"AI_SEARCH":{let t;let a=await E(),i=await D(e.payload.text,a.aiProvider),n=i.replace(/```(?:json)?\s*/g,"").trim();try{t=JSON.parse(n)}catch{return{status:"error",error:`Failed to parse AI response: ${i.slice(0,200)}`}}let r=await L(),l=function(e,t){let a=[],i=["explicit","implicit","enchant","fractured","desecrated"],n=e=>{if(!e.text)return null;let a=R(e.text,t);if(!a)return null;let i={id:a.id,value:{min:e.min??void 0,max:e.max??void 0},disabled:!1};return e.statType&&(i.type=e.statType),i},r=(e,a)=>{let n=new Set(t.map(e=>e.id)),r=[];for(let t=0;t<e.length;t++){let l=e[t],s=a[t];if(s?.statType)r.push(l);else{let e=String(l.id).split("."),t=e.length>1?e.slice(1).join("."):e[0];for(let e of i){let a=e+"."+t;n.has(a)&&r.push({...l,id:a,type:e})}}}return r},l=e=>!e.statType;if(e.stats?.length){let t=[];for(let i=0;i<e.stats.length;i++){let s=e.stats[i],o=n(s);if(o){if(l(s)){let e=r([o],[s]);if(!e.length)continue;if(null!=s.min||null!=s.max){let t=e.map(e=>({...e,value:{}}));a.push({type:"weight",filters:t,value:{min:s.min??void 0,max:s.max??void 0}})}else a.push({type:"count",filters:e,value:{min:1}})}else t.push(o)}}t.length&&a.push({type:"and",filters:t})}if(e.statGroups?.length)for(let t of e.statGroups){let e=t.filters.map(n).filter(Boolean),i=r(e,t.filters);i.length&&a.push({type:t.type,filters:i,value:t.value?.min!=null||t.value?.max!=null?{min:t.value.min,max:t.value.max}:void 0})}let s={query:{status:{option:e.status||"online"},stats:a,filters:{}},sort:"price-desc"===e.sort?{price:"desc"}:{price:"asc"}},o={};if(e.type){let t={Ring:"accessory.ring",Amulet:"accessory.amulet",Belt:"accessory.belt",Boots:"armour.boots",Gloves:"armour.gloves",Helmet:"armour.helmet","Body Armour":"armour.chest",Shield:"armour.shield",Quiver:"armour.quiver",Focus:"armour.focus",Claw:"weapon.claw",Dagger:"weapon.dagger","One Handed Sword":"weapon.onesword","One Handed Axe":"weapon.oneaxe","One Handed Mace":"weapon.onemace",Spear:"weapon.spear",Flail:"weapon.flail","Two Handed Sword":"weapon.twosword","Two Handed Axe":"weapon.twoaxe","Two Handed Mace":"weapon.twomace",Quarterstaff:"weapon.warstaff",Bow:"weapon.bow",Crossbow:"weapon.crossbow",Wand:"weapon.wand",Sceptre:"weapon.sceptre",Staff:"weapon.staff","Life Flask":"flask.life","Mana Flask":"flask.mana",Flask:"flask",Jewel:"jewel",Waystone:"map.waystone",Tablet:"map.tablet",Rune:"currency.rune","Soul Core":"currency.soulcore","Skill Gem":"gem.activegem","Support Gem":"gem.supportgem"}[e.type];t&&(o.category={option:t})}if(e.rarity&&(o.rarity={option:e.rarity}),e.ilvl&&(o.ilvl={},null!=e.ilvl.min&&(o.ilvl.min=e.ilvl.min),null!=e.ilvl.max&&(o.ilvl.max=e.ilvl.max)),e.quality&&(o.quality={},null!=e.quality.min&&(o.quality.min=e.quality.min),null!=e.quality.max&&(o.quality.max=e.quality.max)),Object.keys(o).length&&(s.query.filters={...s.query.filters,type_filters:{filters:o}}),e.equipment?.length||e.runeSockets){let t={};for(let a of e.equipment||[])a.id&&(t[a.id]={},null!=a.min&&(t[a.id].min=a.min),null!=a.max&&(t[a.id].max=a.max));e.runeSockets&&(t.rune_sockets={},null!=e.runeSockets.min&&(t.rune_sockets.min=e.runeSockets.min),null!=e.runeSockets.max&&(t.rune_sockets.max=e.runeSockets.max)),Object.keys(t).length&&(s.query.filters={...s.query.filters,equipment_filters:{filters:t}})}if(e.req?.length){let t={};for(let a of e.req)a.id&&(t[a.id]={},null!=a.min&&(t[a.id].min=a.min),null!=a.max&&(t[a.id].max=a.max));Object.keys(t).length&&(s.query.filters={...s.query.filters,req_filters:{filters:t}})}if(e.name&&(s.query.name=e.name),e.price?.currency||e.saleType||e.listed||e.sellerAccount||null!=e.collapse||e.goldFee){let t={};e.price?.currency&&(t.price={min:e.price.min??void 0,max:e.price.max??void 0,option:e.price.currency}),e.saleType&&(t.sale_type={option:"priced"===e.saleType?null:e.saleType}),e.listed&&(t.indexed={option:e.listed}),e.sellerAccount&&(t.account={input:e.sellerAccount}),null!=e.collapse&&(t.collapse={option:e.collapse?"true":null}),e.goldFee&&(t.fee={},null!=e.goldFee.min&&(t.fee.min=e.goldFee.min),null!=e.goldFee.max&&(t.fee.max=e.goldFee.max)),s.query.filters={...s.query.filters,trade_filters:{filters:t}}}return s}(t,r),c=l.query.stats?.flatMap(e=>e.filters)||[],m=c.filter(e=>!e.disabled).length;await u();let p=[];if(t.type)for(let e of c){if(e.disabled)continue;let a=r.find(t=>t.id===e.id);if(a?.text){let i=function(e,t){if(!s||!t)return{valid:!0};let a=d[t];if(!a)return{valid:!0};let i=o.get(a);if(!i||0===i.size)return{valid:!0};let n=e.replace(/\([\d.\u2014]+\)/g,"#").replace(/[\d.]+/g,"#").replace(/[+\-%]/g,"").replace(/\s+/g," ").trim().toLowerCase();for(let e of i)if(n.startsWith(e))return{valid:!0,categorySlug:a};return{valid:!1,categorySlug:a}}(a.text,t.type);i.valid||(e.disabled=!0,p.push(a.text))}}let y={es:/energy shield/i,ar:/armour(?!.*evasion)/i,ev:/evasion/i};if(["Body Armour","Helmet","Boots","Gloves"].includes(t.type||"")&&t.equipment?.length)for(let e of t.equipment){let t=y[e.id];if(t)for(let e of c){if(e.disabled)continue;let a=r.find(t=>t.id===e.id);a?.text&&t.test(a.text)&&(e.disabled=!0,p.push(a.text+" (\u5df2\u7531\u88c5\u5907\u5c5e\u6027\u8986\u76d6)"))}}if(t.tierHints?.length&&(s?.categories||(s=null,await u()),s&&s.categories&&t.type)){let e=[];for(let a of t.tierHints){let i=R(a.statText,r);if(i){for(let n of l.query.stats)for(let l of n.filters)if(!l.disabled&&l.id===i.id){let i=r.find(e=>e.id===l.id);if(!i?.text)continue;let n=function(e,t,a,i){if(!s)return null;if(!s.categories)return console.log("[PoE2] Tier resolution needs full affix DB, reloading..."),s=null,null;let n=d[t];if(!n)return null;let r=s.categories.find(e=>e.slug===n);if(!r)return null;let l=f(e);if(!l||l.length<3)return null;let o=null,u=r.affixes||[];for(let e of u){if(!e.details)continue;let t=parseInt(e.tier,10);if(t!==a||"implicit"===i)continue;let n=f(e.details);if(n&&!(n.length<3)&&(l.includes(n)||n.includes(l)||l===n)){let t=g(e.details);if(null===t)continue;let a=parseInt(e.level,10)||0;(!o||a>o.level)&&(o={value:t,level:a})}}if("implicit"===i&&r.base_items)for(let e of r.base_items||[])for(let t of e.implicits||[]){let e=f(t);if(l.includes(e)||e.includes(l)||l===e){let e=g(t);null!==e&&(!o||e>o.value)&&(o={value:e,level:0})}}return o?{min:Math.round(o.value)}:null}(i.text,t.type,a.tier,a.statType);n&&(l.value.min=n.min,e.push(`${i.text} \u2192 T${a.tier} (min=${n.min})`));break}}}e.length&&console.log("[PoE2] Tier overrides applied:",e)}let x=(t.statGroups?.flatMap(e=>e.filters)||t.stats||[]).filter(e=>e.text),v=x.filter(e=>!!e.text&&!R(e.text,r)),_={lvl:"\u9700\u6c42\u7b49\u7ea7",str:"\u9700\u6c42\u529b\u91cf",dex:"\u9700\u6c42\u654f\u6377",int:"\u9700\u6c42\u667a\u6167"},A={ar:"\u62a4\u7532",ev:"\u95ea\u907f",es:"\u80fd\u91cf\u62a4\u76fe",block:"\u683c\u6321\u7387",spirit:"\u7cbe\u9b42",dps:"\u79d2\u4f24",pdps:"\u7269\u7406DPS",edps:"\u5143\u7d20DPS",damage:"\u4f24\u5bb3",aps:"\u653b\u901f",crit:"\u66b4\u51fb\u7387",reload_time:"\u88c5\u586b\u65f6\u95f4"},b=[];if(t.rarity&&b.push({normal:"\u767d\u88c5",magic:"\u84dd\u88c5",rare:"\u7a00\u6709",unique:"\u4f20\u5947",nonunique:"\u975e\u4f20\u5947"}[t.rarity]||t.rarity),t.ilvl){let e=null!=t.ilvl.min&&null!=t.ilvl.max?`${t.ilvl.min}-${t.ilvl.max}`:null!=t.ilvl.min?`\u2265${t.ilvl.min}`:`\u2264${t.ilvl.max}`;b.push(`\u7269\u54c1\u7b49\u7ea7${e}`)}if(t.quality){let e=null!=t.quality.min?`\u2265${t.quality.min}`:`\u2264${t.quality.max}`;b.push(`\u54c1\u8d28${e}`)}if(t.runeSockets){let e=null!=t.runeSockets.min?`\u2265${t.runeSockets.min}`:`\u2264${t.runeSockets.max}`;b.push(`${e}\u5b54`)}if(t.req?.length)for(let e of t.req){let t=_[e.id]||e.id,a=null!=e.min&&null!=e.max?`${e.min}-${e.max}`:null!=e.min?`\u2265${e.min}`:`\u2264${e.max}`;b.push(`${t}${a}`)}if(t.saleType&&b.push({priced:"\u4e00\u53e3\u4ef7",priced_with_info:"\u5e26\u5907\u6ce8\u4ef7",unpriced:"\u65e0\u6807\u4ef7"}[t.saleType]||t.saleType),t.listed&&b.push(`\u4e0a\u67b6${{"1hour":"1\u5c0f\u65f6\u5185","3hours":"3\u5c0f\u65f6\u5185","12hours":"12\u5c0f\u65f6\u5185","1day":"1\u5929\u5185","3days":"3\u5929\u5185","1week":"1\u5468\u5185","2weeks":"2\u5468\u5185","1month":"1\u6708\u5185","2months":"2\u6708\u5185"}[t.listed]||t.listed}`),t.sellerAccount&&b.push(`\u5356\u5bb6:${t.sellerAccount}`),t.goldFee){let e=null!=t.goldFee.min&&null!=t.goldFee.max?`${t.goldFee.min}-${t.goldFee.max}`:null!=t.goldFee.min?`\u2265${t.goldFee.min}`:`\u2264${t.goldFee.max}`;b.push(`\u91d1\u5e01\u8d39${e}`)}if(t.price?.currency){let e={chaos:"c",divine:"d",exalted:"e"}[t.price.currency]||t.price.currency,a=null!=t.price.min&&null!=t.price.max?`${t.price.min}-${t.price.max} ${e}`:null!=t.price.min?`\u2265${t.price.min} ${e}`:`\u2264${t.price.max} ${e}`;b.push(`\ud83d ${a}`)}let q=(t.equipment||[]).filter(e=>e.id).map(e=>{let t=A[e.id]||e.id,a=null!=e.min&&null!=e.max?`${e.min}-${e.max}`:null!=e.min?`\u2265${e.min}`:`\u2264${e.max}`;return`${t}${a}`});await h();let C=l.query.stats?.flatMap(e=>e.filters).filter(e=>!e.disabled)||[],k={},O={};for(let e of C){let t=r.find(t=>t.id===e.id);if(t?.text){let a=w(t.text);if(a){let i=t.text+(e.type?"::"+e.type:"");k[i]=a,e.type&&(O[i]=e.type)}}}let $={id:Date.now().toString(36)+Math.random().toString(36).slice(2,6),text:e.payload.text,explanation:t.explanation||"",type:t.type||null,tags:b,matched:m,timestamp:Date.now()};try{let e=await S("searchHistory"),t=e.searchHistory||[];t.unshift($),t.length>50&&(t.length=50),await T({searchHistory:t})}catch(e){console.warn("[PoE2] Failed to save history:",e)}let P=[];for(let e of t.statGroups||[]){let t="count"===e.type?"\u6761\u6570":"weight"===e.type?"\u603b\u548c":e.type,a=[];e.value?.min!=null&&a.push(`\u2265${e.value.min}`),e.value?.max!=null&&a.push(`\u2264${e.value.max}`),P.push(`${t}(${a.join(",")})`)}let I=[];if(t.tierHints?.length&&t.type)for(let e of t.tierHints){let t=R(e.statText,r);if(t){let a=r.find(e=>e.id===t.id);if(a?.text){let t=w(a.text)||a.text;I.push(`T${e.tier} ${t}`)}}}return{status:"success",result:{query:l.query,sort:l.sort,explanation:t.explanation||"",type:t.type||null,equipment:q,tags:b,matched:m,unmatched:v.map(e=>e.text),translations:k,statTypes:O,excluded:p,statSummary:P,tierSummary:I}}}case"GET_STATS":{let e=await L();return{status:"success",result:e}}case"TRANSLATE_STAT":{let t=function(e){if($.has(e))return $.get(e);let t=e;for(let[e,a]of Object.entries(P))t=t.replace(RegExp(e,"gi"),a);return t=t.replace(/(\d+\.?\d*)/g,"$1").replace(/^([+-]?\d+\.?\d*)\s*/,"$1 "),$.set(e,t),t}(e.payload.statText);return{status:"success",result:t}}case"EXECUTE_SEARCH":{let t=await C(e.payload.query,e.payload.league);return{status:"success",result:t}}case"FETCH_ITEMS":{let t=await k(e.payload.hashes,e.payload.searchId);return{status:"success",result:t}}case"GET_SETTINGS":{let e=await E();return{status:"success",result:e}}case"SAVE_SETTINGS":{await v(e.payload);let t=await E(),a=t?.aiProvider?.apiKey===e.payload?.aiProvider?.apiKey;return console.log("[PoE2] Settings saved. Verify:",a?"OK":"MISMATCH","saved_key_len="+(e.payload?.aiProvider?.apiKey?.length||0),"read_key_len="+(t?.aiProvider?.apiKey?.length||0)),{status:"success",result:t}}case"TRANSLATE_BATCH":{await h();let t={};for(let a of e.payload.texts){let e=w(a);e&&(t[a]=e)}return{status:"success",result:t}}case"GET_HISTORY":{let e=await S("searchHistory");return{status:"success",result:e.searchHistory||[]}}case"CLEAR_HISTORY":return await new Promise(e=>{chrome.storage.local.remove("searchHistory",()=>{chrome.runtime.lastError&&console.warn("[PoE2] storageRemove error:",chrome.runtime.lastError),e()})}),{status:"success"};case"RESOLVE_MOD_TIERS":{let{mods:t}=e.payload;c||(s&&s.categories||(s=null),await u(),c||m());let a={};for(let e=0;e<t.length;e++)a[e]=function(e,t){if(!c)return null;let a=e.replace(/\([\d.\u2014]+\)/g,"#").replace(/[\d.]+/g,"#").replace(/[+\-%]/g,"").replace(/\s+/g," ").trim().toLowerCase(),i=c.get(a);if(!i||0===i.length)return null;let n=e.match(/[\d.]+/g)?.map(Number)||[];for(let e=0;e<i.length;e++){let t=i[e],a=t.detail.match(/[\d.]+/g)?.map(Number)||[];if(n.length&&a.length&&a.length>=2&&n.length>=1){let t=Math.min(a[0],a[1]),i=Math.max(a[0],a[1]),r=n[0];if(r>=t&&r<=i)return{tier:e,label:`T${e}`}}}return{tier:0,label:"T0"}}(t[e].text,t[e].category);return{status:"success",result:a}}default:return{status:"error",error:"Unknown message type"}}}chrome.runtime.onMessage.addListener((e,t,a)=>(I(e).then(a).catch(e=>{a({status:"error",error:String(e)})}),!0)),chrome.runtime.onInstalled.addListener(()=>{L().catch(()=>{})}),console.log("[PoE2 Trade Enhancer] Background worker ready")},{"~types":"4xBMi","@parcel/transformer-js/src/esmodule-helpers.js":"f6DG4"}],"4xBMi":[function(e,t,a){var i=e("@parcel/transformer-js/src/esmodule-helpers.js");i.defineInteropFlag(a),i.export(a,"DEFAULT_SETTINGS",()=>n);let n={aiProvider:{apiUrl:"https://api.deepseek.com/v1/chat/completions",apiKey:"",model:"deepseek-chat"},showChineseAffixes:!0,showTierLabels:!0,autoCollapseOutOfTier:!1}},{"@parcel/transformer-js/src/esmodule-helpers.js":"f6DG4"}],f6DG4:[function(e,t,a){a.interopDefault=function(e){return e&&e.__esModule?e:{default:e}},a.defineInteropFlag=function(e){Object.defineProperty(e,"__esModule",{value:!0})},a.exportAll=function(e,t){return Object.keys(e).forEach(function(a){"default"===a||"__esModule"===a||t.hasOwnProperty(a)||Object.defineProperty(t,a,{enumerable:!0,get:function(){return e[a]}})}),t},a.export=function(e,t,a){Object.defineProperty(e,t,{enumerable:!0,get:a})}},{}]},["kgW6q"],"kgW6q","parcelRequire1dc8"),globalThis.define=t;