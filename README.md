...
- **T级词缀标签** — 物品弹窗中 T0/T1/T2 金色/银色/铜色标签（实验性）
...
### Firefox
1. 下载 `poe2-trade-enhancer-ff.zip`
2. 解压
3. `about:debugging#/runtime/this-firefox` → 临时载入附加组件 → 选择 `manifest.json`
...
- **显示中文词缀** — 开启/关闭页面翻译
- **显示 T 级标签** — 开启/关闭物品弹窗中 T0/T1/T2 词缀等级标签
